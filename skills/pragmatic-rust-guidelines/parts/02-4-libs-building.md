# Libraries - Building & Cargo Features

> Pragmatic Rust Guidelines - Part 02.4
> Source category: `libs/building`

## Table of Contents

- **Libraries work out of the box (M-OOBE)**: easy adoption across the Rust ecosystem.
- **Native `-sys` crates compile without dependencies (M-SYS-CRATES)**: libraries that just work on all platforms.
- **Features are additive (M-FEATURES-ADDITIVE)**: reliable compilation in large, complex projects.
...
> **Rationale**: easy adoption across the Rust ecosystem.
...
> **Rationale**: libraries that just work on all platforms.
...
<a id="M-FEATURES-ADDITIVE"></a>

## Features are additive (M-FEATURES-ADDITIVE)

> **Rationale**: reliable compilation in large, complex projects.
