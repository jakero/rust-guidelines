...
> Pragmatic Rust Guidelines - Part 06
> Source category: `correctness`

## Table of Contents

- **Unsafe needs reason, should be avoided (M-UNSAFE)**: memory safety and a minimal attack surface.
- **All code must be sound (M-UNSOUND)**: predictable runtime behavior free of bugs and incompatibilities.
- **Unsafe implies undefined behavior (M-UNSAFE-IMPLIES-UB)**: semantic consistency without warning fatigue.
- **Panic means 'stop the program' (M-PANIC-IS-STOP)**: soundness and predictability.
- **Detected programming bugs are panics, not errors (M-PANIC-ON-BUG)**: tractable error handling and runtime consistency.
- **Panic continuation is last resort (M-PANIC-CONTINUATION)**: state integrity and freedom from subtle bugs.
- **Custom panics have a helpful message (M-PANIC-MESSAGE)**: faster bug diagnosis.
...
> **Rationale**: memory safety and a minimal attack surface.
...
> **Rationale**: predictable runtime behavior free of bugs and incompatibilities.
...
> **Rationale**: semantic consistency without warning fatigue.
...
> **Rationale**: soundness and predictability.
...
> **Rationale**: tractable error handling and runtime consistency.
...
> **Rationale**: state integrity and freedom from subtle bugs.
...
> **Rationale**: faster bug diagnosis.
