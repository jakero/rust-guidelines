...
> Pragmatic Rust Guidelines - Part 05
> Source category: `ffi`

## Table of Contents

- **Isolate DLL state between FFI libraries (M-ISOLATE-DLL-STATE)**: data integrity and defined behavior across DLL boundaries.
- **Business logic belongs in core crates, FFI only translates (M-FFI-TRANSLATES)**: maximal safe code and a clean separation of concerns.
- **FFI crates follow established naming conventions (M-FFI-NAMING)**: immediately recognizable crate roles across projects.
...
> **Rationale**: data integrity and defined behavior across DLL boundaries.
...
> **Rationale**: maximal safe code and a clean separation of concerns.
...
> **Rationale**: immediately recognizable crate roles across projects.
